...
| `src/app-hosts/linnya/adapters/inference/` | 单次 attempt 的 route admission、凭据解析、图片/输出门禁、capability 选择、事件身份与安全诊断投影 | 模型目录、Agent retry/切模、工具执行、Graph/Run 终态、Provider body 持久化 | Model Catalog public contract、Linnkit port、Host capability |
