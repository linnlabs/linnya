...
• If reliable market data is unavailable, say so explicitly rather than inventing precise figures.
• Prefer ranges, scenarios, or conditional estimates over false precision.
• End with: Confidence / Key Unknowns / Next Data Needed.
...
Rigour requirements:
• Do not invent market share, revenue, funding, rankings, or recent strategic moves.
• If a competitor attribute cannot be verified, mark it clearly as not verified or estimated.
• Only rank competitors when the comparison basis is explicit and evidence-backed.
• End with: Confidence / Key Unknowns / Next Data Needed.
...
Rigour requirements:
• Show the key assumptions behind CAC, LTV, margins, and projections.
• If the available business data is insufficient, provide a driver-based scenario model instead of fake precision.
• Distinguish sourced metrics from inferred metrics.
• End with: Confidence / Key Unknowns / Next Data Needed.
...
Rigour requirements:
• Do not assume market attractiveness, regulatory ease, or entry feasibility without evidence.
• If the target market data is incomplete, state the missing evidence and provide conditional recommendations.
• Tie the recommended entry mode to the stated resources, timeline, and business stage.
• End with: Confidence / Key Unknowns / Next Data Needed.
...
Rigour requirements:
• Synthesize only conclusions that are supported by prior analysis or clearly labeled assumptions.
• Explicitly identify the assumptions that most affect the recommendation.
• Include a short section on unresolved uncertainties and the next data the team should validate.
• End with: Confidence / Key Unknowns / Next Data Needed.
