...
`BackendBootstrapFacts`、Main 在任何内部环境写入前捕获的 `HostProcessEnvironment`、已经验证的固定 Node 路径、
...
不能加入函数、Electron 对象、Desktop port、任意方法表或业务请求。child 校验完成后才允许初始化 Backend owner，
