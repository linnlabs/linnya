...
export default defineConfig({
  entry: {
    ...
    'linnya-cli-runtime': 'src/app-hosts/linnya/cli-runtime/entry/cliRuntimeHostEntry.ts',
  },
  format: ['cjs'],
  platform: 'node',
  outDir: 'dist/main',
  ...
  noExternal: [
    /^(?!(?:electron|electron-store|better-sqlite3|yoga-layout|sharp|@node-rs\/jieba|@napi-rs\/(?:canvas|keyring)|pdfjs-dist|canvas)(?:$|\/)).*/,
  ],
