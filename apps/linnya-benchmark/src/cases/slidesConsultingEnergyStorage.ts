...
export const slidesConsultingEnergyStorageCase = {
  id: 'slides_consulting_energy_storage_v1',
  revision: 1,
  name: '咨询风格 Slides：中国电网侧储能与电力设备',
  description: '验证 Agent 能否完成储能与电力设备资料研究，并形成十页、结论先行的高密度咨询 Slides。',
  tags: ['slides', 'consulting', 'high-density', 'web-research', 'chinese'],
  agentId: 'slides_agent',
  reasoningEffort: 'high',
  timeoutMs: 90 * 60 * 1000,
  promptTemplate: `请制作一份恰好 10 页、16:9 的中文咨询/投研风格 PPT，主题为《2026 年中国电网侧储能与电力设备投资机会》。这是一次真实咨询交付测试，不是概念海报或演讲提纲。
...
请使用公开可信资料完成必要研究，数据口径尽量截至 2026 年 8 月。优先使用国家能源局、电网公司、上市公司公告/年报、国际能源署、行业协会和其他一手来源；关键数字必须在相应页面标明来源与年份，无法确认的数据不要编造。成品必须恰好 10 页，形成连续论证链，并至少覆盖：封面、执行摘要、新型电力系统需求驱动、市场空间与测算口径、储能技术路线比较、产业链与价值量、电网设备升级机会、竞争格局及代表企业、催化剂与风险、投资结论与跟踪指标。
