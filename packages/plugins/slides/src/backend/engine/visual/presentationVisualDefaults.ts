export { resolveShapeTextLayout, estimateShapeTextFontSize } from '@plugin/slides/shared/textLayout';
export type { ShapeTextLayout } from '@plugin/slides/shared/textLayout';
