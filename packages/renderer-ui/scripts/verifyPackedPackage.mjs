...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      "import { ActionButtons, ColorPickerPanel, CustomNumberInput, CustomSlider, CustomTextInput, DraggablePanel, FloatingToolbar, ToolbarGroup, ToolbarButton, ToolbarColorButton, DropdownPanel, HoverTooltip, NotificationBar, SimpleDatePicker, TimePicker, createColorPickerOptions, resolveDraggablePanelPosition, resolveHoverTooltipPosition } from '@linnya/renderer-ui';",
      ...
      "    h(ToolbarColorButton, { label: 'Text color', kind: 'text', color: '#000000', expanded: true }),",
      "    h(DropdownPanel, { show: true, direction: 'up' }, { default: () => h(ToolbarButton, { label: 'Apply' }, { default: () => 'Apply' }) }),",
