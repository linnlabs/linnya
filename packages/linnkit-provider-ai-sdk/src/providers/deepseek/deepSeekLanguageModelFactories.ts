import { createDeepSeek, VERSION as DEEPSEEK_PACKAGE_VERSION } from '@ai-sdk/deepseek';
import {
...
export const DEEPSEEK_LANGUAGE_MODEL_FACTORIES: Record<
  typeof AI_SDK_INFERENCE_CAPABILITY_IDS.DEEPSEEK_CHAT,
...
> = {
  [AI_SDK_INFERENCE_CAPABILITY_IDS.DEEPSEEK_CHAT]: {
    ...
    package_version: DEEPSEEK_PACKAGE_VERSION,
